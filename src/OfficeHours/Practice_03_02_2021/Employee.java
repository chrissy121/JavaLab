...
public class Employee {
    public static void main(String[] args) {
        String firstName = "Bolormaa", lastName = " Baasankhuu ", companyName = "Tesla ";
        ...
        System.out.println("Your start date as a SDET will be on " + startMonth+ " " + startDay + "," + startYear);
        System.out.println("You are fulltime: " + areTheyFullTime + " and will be making " + salary + " per year" );
